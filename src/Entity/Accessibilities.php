...
/**
 * @ORM\Entity(repositoryClass="App\Repository\AccessibilitiesRepository")
 */
class Accessibilities
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Parc", mappedBy="accessibility")
     */
    private $parcs;
